...
public class Main {
    public static void main(String[] args) {
        ...
        team1.addWarrior(new Swordman("Vasya", 250, new Sword(25)))
        .addWarrior(new Swordman("John", 200, new Sword(50)));
        ...
        team2.addWarrior(new Archer("Kolya", 150, new Bow(100, 50)))
        .addWarrior(new Archer("Paul", 200, new Bow(75, 70)));
